    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <p class="text-gray-400 text-sm leading-relaxed mb-4">
            The first Dart & Node.js feature flag platform built for modern development teams.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">SDK Downloads</a></li>
          </ul>
        </div>
      ...
      <div class="border-t border-gray-800 pt-8 mb-8">
        <div class="max-w-md">
          ...
          <p class="text-gray-400 text-sm mb-4">Get the latest updates on feature flags and best practices</p>
          <form class="flex gap-2">
            <input 
              type="email" 
              placeholder="Enter your email" 
              class="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-md text-white placeholder-gray-500 focus:outline-none focus:border-accent-orange"
            />
            <button type="submit" class="bg-accent-orange hover:bg-orange-500 text-white px-6 py-2 rounded-md font-semibold transition-colors">
              Subscribe
            </button>
          </form>
        </div>
      ...
      <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p class="text-gray-400 text-sm">
          © 2024 IntelliToggle. All rights reserved.
        </p>
